"""
Django settings for python_azure project.
...
SECRET_KEY = 'd@w=q+qdbms$%(!(5gles=@o-t8rvdfpuh^*$@h1n95uk1_k=o'
...
ROOT_URLCONF = 'python_azure.urls'
...
WSGI_APPLICATION = 'python_azure.wsgi.application'
